...
namespace ArrayListTests
{
    ...
    [TestClass]
    public class ComplexTestAList1 : ComplexMSTests
    {
        internal override IList MakeList()
        {
            return new AList1();
    ...
    [TestClass]
    public class ComplexTestAList2 : ComplexMSTests
    {
        internal override IList MakeList()
        {
            return new AList2();
    ...
    [TestClass]
    public class ComplexTestLList1 : ComplexMSTests
    {
        internal override IList MakeList()
        {
            return new LList1();
    ...
    [TestClass]
    public class ComplexTestLList2 : ComplexMSTests
    {
        internal override IList MakeList()
        {
            return new LList2();
    ...
    [TestClass]
    public class ComplexTestLListR : ComplexMSTests
    {
        internal override IList MakeList()
        {
            return new LListR();
